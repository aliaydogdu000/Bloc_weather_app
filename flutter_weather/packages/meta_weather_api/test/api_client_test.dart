      ...
      test('returns weather on valid response', () async {
        ...
        expect(
          ...
          isA<Weather>()
              ...
              .having((w) => w.windDirectionCompass, 'wind', WindDirectionCompass.southWest)
              .having((w) => w.created, 'created', DateTime.parse('2020-10-26T00:20:01.840132Z'))
              .having((w) => w.applicableDate, 'applicableDate', DateTime.parse('2020-10-26'))
              ...
              .having((w) => w.windDirection, 'windDirection', 246.17046093256732)
